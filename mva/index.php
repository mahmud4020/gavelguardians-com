...
<head>
    ...
    <title>Major Cash Settlement for Auto Accidents of ANY Kind.</title>
    <meta name="description" content="Major Cash Settlement for Auto Accidents of ANY Kind." />
    <meta name="keywords" content="GavelGuardians, GavelGuardians, MVA Attorney">
    <link href="/chat-bot-assets/assets/css/style.css" rel="stylesheet" media="all" />
    <style>
        .typing-animation {
            display: inline-flex;
            align-items: center;
...
})(window,document,'script','dataLayer','GTM-TDRD354Q');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TDRD354Q"
...
<!-- End Google Tag Manager (noscript) -->
    <main class="min-h-screen">
        ...
        <div class="max-w-4xl mx-auto bg-white text-center text-gray-600">
            <div class="p-4">
                <p class="font-serif text-md sm:text-lg font-bold mt-2 hidden"><span class="text-red-600">Warning:</span>
                    Limited time to apply - Closed at <span id="currentDate">Sunday, 04/28/2024</span> at
                    midnight.</p>
                <h2 class="font-bold text-3xl sm:text-3xl mt-1">
                    Major Cash Settlement for Auto Accidents of ANY Kind.
                </h2>
                <p>
                    100's of people are injured in accidents every day and most have serious injuries that deserve compensation
                </p>
            </div>
                    ...
                    <div class="chat-container pb-2">
                        ...
                        <div id="agentBlock1" class="flex items-end w-5/6">
                            <div class="flex-shrink-0">
                                <img class="w-8 h-8 rounded-full" src="/chat-bot-assets/assets/images/agent.webp" alt="Sender Avatar">
                            </div>
                            <div class="ml-3 agent-chat">
                                ...
                                <div id="msg1" class="bg-gray-200 p-3 rounded-lg shadow-xs mt-2 w-fit hidden">
                                    <p class="text-md text-gray-800">Hello 👋</p>
                                </div>
                                <div id="msg2" class="bg-gray-200 p-3 rounded-lg shadow-xs mt-2 w-fit hidden">
                                    <p class="text-md text-gray-800"> I’m Emily From Gavel Guardians.</p>
                                </div>
                                <div id="msg3" class="bg-gray-200 p-3 rounded-lg shadow-xs mt-2 w-fit hidden">
                                    <p class="text-md text-gray-800">
                                        Want to find out if you qualify for Maximum Compensation? 😃
                                    </p>
                                </div>
                                <div id="msg4" class="bg-gray-200 p-3 rounded-lg shadow-xs mt-2 w-fit hidden">
                                    <div class="">
                                        <button class="chat-button text-white font-bold bg-blue-500 rounded-full py-3 px-12" type="button" data-form-step="1" data-form-value="Yes">Yes</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="userBlock1" class="flex items-start justify-end pt-4 hidden">
                            ...
                            <div class="flex-shrink-0">
                                <img class="w-8 h-8 rounded-full" src="/chat-bot-assets/assets/images/profile.png" alt="Receiver Avatar">
                            </div>
                        </div>
                        ...
                        <div id="agentBlock2" class="flex items-end w-5/6 hidden pt-4">
                            ...
                            <div class="ml-3 agent-chat">
                                <div id="msg6" class="bg-gray-200 p-3 rounded-lg shadow-xs mt-2 w-fit hidden">
                                    <p class="text-md text-gray-800">Okay, let me ask you a couple questions.</p>
                                </div>
                          ...
                          <div id="agentBlock3" class="flex items-end w-5/6 hidden pt-4">
                            ...
                            <div class="ml-3 agent-chat">
                                <div id="msg10" class="bg-gray-200 p-3 rounded-lg shadow-xs mt-2 w-fit hidden">
                                    <p class="text-md text-gray-800">
                                        Did the accident cause medical treatment?
                                    </p>
                                </div>
                                <div id="msg11" class="bg-gray-200 p-3 rounded-lg shadow-xs mt-2 w-fit hidden">
                                    <div class="grid grid-rows-1 grid-cols-2 gap-x-3">
                                        <button
                                            ...
                                            type="button" data-form-value="Yes" onclick="showConguras()">Yes</button>
                                        <button
                                            class="chat-button text-white font-bold bg-blue-500 rounded-full py-3 px-8"
                                            type="button"
                                            data-form-value="No" onclick="showSorry()">No</button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <!-- User message -->
                        <div id="userBlock3b" class="flex items-start justify-end hidden">
                            <div class="mr-3 receiver-chat">

                                <div class="bg-blue-500 text-white p-3 rounded-lg shadow-xs mt-2 inline-block">
                                    <p id="msg12yes-b" class="text-md hidden">Yes</p>
                                    <p id="msg12no-b" class="text-md hidden">No</p>
                                </div>

                                <!--<div class="bg-blue-500 text-white p-3 rounded-lg shadow-xs mt-2 inline-block">
							<p id="msg12-18-35" class="text-md hidden">18-35</p>
							<p id="msg12-36-55" class="text-md hidden">36-55</p>
							<p id="msg12-over55" class="text-md hidden">Over 55</p>
						</div>-->
                        ...
                        <!--end new addtion - 56 age question-->
                        ...
                        <div id="agentBlock4" class="flex items-end w-5/6 hidden pt-4">
                            ...
                            <div class="ml-3 agent-chat">
                                ...
                                <div id="msg14" class="bg-gray-200 p-3 rounded-lg shadow-xs mt-2 w-fit hidden">
                                    <p id="msg14approved" class="text-md text-gray-800 hidden">You're pre qualified.</p>
                                    <p id="msg14disapproved" class="text-md text-gray-800 hidden">You're pre qualified.
                                    </p>
                                </div>
                                <div id="msg15" class="bg-gray-200 p-3 rounded-lg shadow-xs mt-2 w-fit hidden">
                                    <p class="text-md text-gray-800">
                                        Settlement money can be used for lost wages, medical expenses and so on.
                                    </p>
                                </div>
                                <div id="msg16" class="bg-gray-200 p-3 rounded-lg shadow-xs mt-2 w-fit hidden">
                                    <p id="msg16approved" class="text-md text-gray-800 hidden">Tap the number below to call now for your free case review, it only takes 2 mins.</p>
                                    <p id="msg16disapproved" class="text-md text-gray-800 hidden">Tap the number below to call now for your free case review, it only takes 2 mins.</p>
                                </div>
                                <div id="msg17" class="bg-gray-200 p-3 rounded-lg shadow-xs mt-2 w-fit hidden">
                                    <p class="text-md text-gray-800 py-2">
                                        <a id="PrimaryNumber" href="tel:8883761192" class="chat-button text-white font-bold bg-blue-500 rounded-full py-3 px-8 hidden ttc-button" onclick="dataLayer.push({'event': 'Contact'});">
                                            (888) 376-1192
                                        </a>
                                        <a id="DownsellNumber" href="tel:8883761192" class="chat-button text-white font-bold bg-blue-500 rounded-full py-3 px-8 hidden" onclick="dataLayer.push({'event': 'Contact'});">
                                            (888) 376-1192
                                        </a>
                                    </p>
                                </div>
    ...
    <footer class="bg-gray-100 border-t border-t-1 border-t-gray-200 mt-8">
        <div class="mx-auto max-w-7xl overflow-hidden px-6 py-8 lg:px-8 text-sm sm:text-md leading-5 sm:leading-6 text-gray-500">
            ...
            <p class="text-center" style="margin-top: 5px;">
                &copy; 2024 Gavelguardians.com All Rights Reserved.
            </p>
        </div>
    </footer>

    <script type="text/javascript" src="/chat-bot-assets/assets/js/jquery.min.js"></script>
    <script>
            ...
            $('button.chat-button').on('click', function() {
                ...
                if (currentStep == 2) {
                    ...
                    if (buttonValue == 'No') {
                        ...
                        $('#hdnIncomeOver60K').val('Yes');
                    } else {
                        $('#msg9yes').removeClass('hidden');
                        $('#hdnIncomeOver60K').val('No');
                    }
                    scrollToBottom();
                    setTimeout(function() {
                ...
                if (currentStep == 3) {
                    ...
                    if (buttonValue == 'No') {
                        ...
                        $('#hdnMedicaidMedicare').val('No');
                    } else if (buttonValue == 'Medicaid') {
                        $('#msg12medicaid').removeClass('hidden');
                        $('#hdnApprovalStatus').val('no');
                        $('#hdnMedicaidMedicare').val('Medicaid');
                    } else {
                        $('#hdnMedicaidMedicare').val('Medicare');
                    ...
                    scrollToBottom();
                    setTimeout(function() {
                        $('#agentBlock3b').removeClass('hidden');
                        scrollToBottom();
                        setTimeout(function() {
                            $('.temp-typing').remove();
                            $('#msg10-b').removeClass('hidden').after(typingEffect());
                            scrollToBottom();
                            setTimeout(function() {
                                $('.temp-typing').remove();
                                $('#msg11-b').removeClass('hidden');
                                scrollToBottom();
                            }, 0);
                        }, 1750);
                    }, 50);
                ...
                if (currentStep == '3b') {
                    ...
                    //scrollToBottom();
                    if (buttonValue == 'Yes') {
                        $('#msg12yes-b').removeClass('hidden');
                        //Yes => age-approved=no
                        //addParamsToURL('No');
                        $('#hdnAgeApproved').val('No');
                    } else {
                        $('#msg12no-b').removeClass('hidden');
                        //No => age-approved=yes
                        //addParamsToURL('Yes');
                    ...
                    if ($('#hdnApprovalStatus').val() == 'no') {
                        ...
                        //script.src = '//b-js.ringba.com/CAa1c02c3b3c214cf593387dcccfab139b';
                    ...
                    var hdnIncomeOver60K = $('#hdnIncomeOver60K').val();
                    var hdnMedicaidMedicare = $('#hdnMedicaidMedicare').val();
                    window._rgba_tags = (window._rgba_tags || []);
                    window._rgba_tags.push({
                        hdnAgeApproved: isAgeVerified
                    });
                    window._rgba_tags.push({
                        incomeOver60k: hdnIncomeOver60K
                    });
                    window._rgba_tags.push({
                        hasMedicareMedicaid: hdnMedicaidMedicare
                    });
        ...
        function showConguras() {
            ...
            $('#msg11').addClass('hidden');
            $('#userBlock3b,#msg12yes-b').removeClass('hidden');
            setTimeout(function() {
                $('#agentBlock4').removeClass('hidden');
                $('#agentBlock4 .agent-chat').prepend(typingEffect());
                scrollToBottom();
        ...
        function addParamsToURL(val) {
            var currentUrl = window.location.href;
            var separator = currentUrl.includes('?') ? '&' : '?';
            var newUrl = currentUrl + separator + 'age-approved=' + val;
