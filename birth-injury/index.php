...
<head>
    ...
    <title>Birth Injury lawsuits</title>
    <meta name="description" content="Birth Injury lawsuits" />
    <meta name="keywords" content="Birth Injury lawsuits, GavelGuardians, Birth injury attorney">
        ...
        <div class="max-w-4xl mx-auto bg-white text-center text-gray-600">
            <div class="p-4">
                <p class="font-serif text-md sm:text-lg font-bold mt-2"><span class="text-red-600">Warning:</span>
                    Limited time to apply <span id="currentDate">Tuesday, 11/04/2024</span> at
                    midnight.</p>
                <h2 class="font-bold text-xl sm:text-3xl mt-1">
                    Medical Malpractice Attorneys Fighting For You
                </h2>
                <p>
                ...
                <div class="space-y-4">
                    <div class="chat-container pb-2">
                        ...
                        <div id="agentBlock1" class="flex items-end w-5/6">
                            ...
                            <div class="ml-3 agent-chat">
                                ...
                                <div id="msg3" class="bg-gray-200 p-3 rounded-lg shadow-xs mt-2 w-fit hidden">
                                    <p class="text-md text-gray-800">Want to find out if you qualify for compensation and attorney representation? 😃</p>
                                </div>
                        ...
                        <div id="userBlock1" class="flex items-start justify-end pt-4 hidden">
                            ...
                            <div class="flex-shrink-0">
                                <img class="w-8 h-8 rounded-full" src="/chat-bot-assets/assets/images/profile.png"
                                    alt="Receiver Avatar">
                            </div>
                        </div>
                        ...
                        <div id="agentBlock2" class="flex items-end w-5/6 hidden pt-4">
                            ...
                            <div class="ml-3 agent-chat">
                                ...
                                <div id="msg7" class="bg-gray-200 p-3 rounded-lg shadow-xs mt-2 w-fit hidden">
                                    <p class="text-md text-gray-800">
                                        Did your child suffer any of the following? <br>
                                        Cerebral Palsy <br>
                                        Erbs Palsy/Shoulder Dystocia <br>
                                ...
                                <div id="msg8" class="bg-gray-200 p-3 rounded-lg shadow-xs mt-2 w-fit hidden">
                                    <div class="grid grid-rows-1 grid-cols-2 gap-x-3">
                                        <button
                                            ...
                                            type="button" data-form-step="2" data-form-value="Yes"
                                            onclick="showConguras()">Yes</button>

                                        <button
                                            class="chat-button text-white font-bold bg-blue-500 rounded-full py-3 px-8"
                                            type="button" data-form-step="2" data-form-value="No"
                                            onclick="showSorry()">No</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="agentBlock4" class="flex items-end w-5/6 hidden pt-4">
                            ...
                            <div class="ml-3 agent-chat">
                                ...
                                <div id="msg16" class="bg-gray-200 p-3 rounded-lg shadow-xs mt-2 w-fit hidden">
                                    <p id="msg16approved" class="text-md text-gray-800 hidden">Tap the number below to your claim started.</p>
                                    <p id="msg16disapproved" class="text-md text-gray-800 hidden">Tap the number below to your claim started.</p>
                                </div>
        ...
        $(document).ready(function () {
            ...
            $('button.chat-button').on('click', function () {
                ...
                if (currentStep == '3b') {
                    ...
                    window._rgba_tags.push({ hdnAgeApproved: isAgeVerified });
                    window._rgba_tags.push({ incomeOver60k: hdnIncomeOver60K });
                    window._rgba_tags.push({ hasMedicareMedicaid: hdnMedicaidMedicare });
